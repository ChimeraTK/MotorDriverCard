...
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::initialEvent("initialEvent");
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::moveEvent("moveEvent");
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::stopEvent("stopEvent");
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::errorEvent("errorEvent");
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::emergencyStopEvent("emergencyStopEvent");
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::actionCompleteEvent(
        "actionCompletedEvent");
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::enableEvent("enableEvent");
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::disableEvent("disableEvent");
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::resetToIdleEvent("resetToIdleEvent");
const utility::StateMachine::Event
    BasicStepperMotor::StateMachine::resetToDisableEvent("resetToDisableEvent");

BasicStepperMotor::StateMachine::StateMachine(BasicStepperMotor &stepperMotor)
    : utility::StateMachine(), _moving("moving"), _idle("idle"),
      _disabled("disabled"), _error("error"), _stepperMotor(stepperMotor),
      _motorControler(stepperMotor._motorControler) {
  _initState.setTransition(initialEvent, &_disabled, [] {});
  _idle.setTransition(
      moveEvent, &_moving,
      std::bind(&BasicStepperMotor::StateMachine::actionIdleToMove, this),
      std::bind(&BasicStepperMotor::StateMachine::waitForStandstill, this));
  _idle.setTransition(
      disableEvent, &_disabled,
      std::bind(&BasicStepperMotor::StateMachine::actionDisable, this));
  _moving.setTransition(
      stopEvent, &_idle,
      std::bind(&BasicStepperMotor::StateMachine::actionMovetoStop, this));
  _moving.setTransition(errorEvent, &_error, [] {});
  _moving.setTransition(
      emergencyStopEvent, &_error,
      std::bind(&BasicStepperMotor::StateMachine::actionEmergencyStop, this));
  _moving.setTransition(
      disableEvent, &_disabled,
      std::bind(&BasicStepperMotor::StateMachine::actionDisable, this));
  _disabled.setTransition(
      enableEvent, &_idle,
      std::bind(&BasicStepperMotor::StateMachine::actionEnable, this));
  _error.setTransition(
      resetToIdleEvent, &_idle,
      std::bind(&BasicStepperMotor::StateMachine::actionResetError, this));
  _error.setTransition(
      resetToDisableEvent, &_disabled,
      std::bind(&BasicStepperMotor::StateMachine::actionResetError, this));
}
