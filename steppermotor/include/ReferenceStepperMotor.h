...
#pragma once
#ifndef CHIMERATK_REFERENCE_STEPPER_MOTOR_H
#  define CHIMERATK_REFERENCE_STEPPER_MOTOR_H

#  include "BasicStepperMotor.h"

namespace ChimeraTK::MotorDriver {
  class ReferenceStateMachine; // <-- forward declaration
  ...
  class ReferenceStepperMotor : public BasicStepperMotor {
   public:
     ...
     */
    explicit ReferenceStepperMotor(const StepperMotorParameters&);
   ...
   protected:
    ...
    virtual std::shared_ptr<utility::StateMachine> createStateMachine() = 0;
  };
} // namespace ChimeraTK::MotorDriver
#endif /* CHIMERATK_REFRENCE_STEPPER_MOTOR_H */
