...
#pragma GCC diagnostic pop
  ...
  ChimeraTK::MotorDriverCardFactory const& instance1 = ChimeraTK::MotorDriverCardFactory::instance();
  ChimeraTK::MotorDriverCardFactory const& instance2 = ChimeraTK::MotorDriverCardFactory::instance();
...
#pragma GCC diagnostic pop
  ...
  BOOST_CHECK(ChimeraTK::MotorDriverCardFactory::getDeviceaccessDMapFilePath() == "MD22_on_DAMC2.dmap");

  // set using the MotorDriverCardFactory's interface
  ChimeraTK::MotorDriverCardFactory::setDeviceaccessDMapFilePath("dummies.dmap");
...
#pragma GCC diagnostic pop
  ...
  boost::shared_ptr<ChimeraTK::MotorDriverCard> motorDriverCard_PCIe1 =
      // MotorDriverCardFactory::instance().createMotorDriverCard(DUMMY_DEV_PATH,
      ChimeraTK::MotorDriverCardFactory::instance().createMotorDriverCard(DFMC_ALIAS2, MODULE_NAME_0, CONFIG_FILE);
  BOOST_CHECK(true);
  boost::shared_ptr<ChimeraTK::MotorDriverCard> md22_dummy1 =
      ChimeraTK::MotorDriverCardFactory::instance().createMotorDriverCard(DFMC_ALIAS, MODULE_NAME_0, CONFIG_FILE);
  ...
  boost::shared_ptr<ChimeraTK::MotorDriverCard> md22_dummy2 =
      ChimeraTK::MotorDriverCardFactory::instance().createMotorDriverCard(DFMC_ALIAS, MODULE_NAME_0, CONFIG_FILE);
  ...
  boost::shared_ptr<ChimeraTK::MotorDriverCard> motorDriverCard_PCIe2 =
      ChimeraTK::MotorDriverCardFactory::instance().createMotorDriverCard(DFMC_ALIAS2, MODULE_NAME_0, CONFIG_FILE);
...
#pragma GCC diagnostic pop
  ChimeraTK::MotorDriverCardFactory::instance().setDummyMode(true);
  boost::shared_ptr<ChimeraTK::MotorDriverCardDummy> motorDriverCardDummy =
      boost::dynamic_pointer_cast<ChimeraTK::MotorDriverCardDummy>(
          ChimeraTK::MotorDriverCardFactory::instance().createMotorDriverCard("/dummy/MotorDriverCard",
