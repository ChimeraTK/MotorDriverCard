...
const LinearStepperMotorStatus
    LinearStepperMotorStatusTypes::M_POSITIVE_END_SWITCHED_ON(128);
const LinearStepperMotorStatus
    LinearStepperMotorStatusTypes::M_NEGATIVE_END_SWITCHED_ON(256);
...
LinearStepperMotorStatus::LinearStepperMotorStatus(int id)
    : StepperMotorStatus(id) {}

LinearStepperMotorStatus::LinearStepperMotorStatus(
    const LinearStepperMotorStatus &status)
...
const StepperMotorStatus
    StepperMotorStatusTypes::M_SOFT_POSITIVE_END_SWITCHED_ON(16);
const StepperMotorStatus
    StepperMotorStatusTypes::M_SOFT_NEGATIVE_END_SWITCHED_ON(32);
...
StepperMotorStatus::StepperMotorStatus(const StepperMotorStatus &status)
