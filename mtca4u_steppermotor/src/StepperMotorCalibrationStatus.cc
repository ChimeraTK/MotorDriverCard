...
const StepperMotorCalibrationStatus
    StepperMotorCalibrationStatusType::M_CALIBRATION_UNKNOWN(1);
const StepperMotorCalibrationStatus
    StepperMotorCalibrationStatusType::M_CALIBRATED(2);
const StepperMotorCalibrationStatus
    StepperMotorCalibrationStatusType::M_NOT_CALIBRATED(4);
const StepperMotorCalibrationStatus
    StepperMotorCalibrationStatusType::M_CALIBRATION_FAILED(8);
const StepperMotorCalibrationStatus
    StepperMotorCalibrationStatusType::M_CALIBRATION_IN_PROGRESS(16);
const StepperMotorCalibrationStatus
    StepperMotorCalibrationStatusType::M_CALIBRATION_STOPPED_BY_USER(32);
const StepperMotorCalibrationStatus
    StepperMotorCalibrationStatusType::M_CALIBRATION_NOT_AVAILABLE(64);

//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// StepperMotorCalibrationStatus class definition !!!!!!!!!!!!!!!!!!!!!!!!!
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

StepperMotorCalibrationStatus::StepperMotorCalibrationStatus()
    : GeneralStatus(1) {}

StepperMotorCalibrationStatus::StepperMotorCalibrationStatus(int id)
    : GeneralStatus(id) {}

StepperMotorCalibrationStatus::StepperMotorCalibrationStatus(
    const StepperMotorCalibrationStatus &error)
    : GeneralStatus(error) {}
