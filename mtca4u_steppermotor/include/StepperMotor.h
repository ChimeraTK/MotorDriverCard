...
using StepperMotorUnitsConverter =
    ChimeraTK::MotorDriver::utility::MotorStepsConverter;
using StepperMotorUnitsConverterTrivia =
    ChimeraTK::MotorDriver::utility::MotorStepsConverterTrivia;
...
public:
   ...
   */
  virtual void setCurrentPositionAs(
      float newPosition); // old name: setCurrentMotorPositionAs
  ...
  void setStepperMotorUnitsConverter(
