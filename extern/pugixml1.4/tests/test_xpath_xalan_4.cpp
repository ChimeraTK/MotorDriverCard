...
TEST_XML_FLAGS(xpath_xalan_position_2,
    "<doc><a "
...
TEST_XML(xpath_xalan_position_3,
  ...
  CHECK_XPATH_NODESET(doc,
      STR("(article//section/title|/articleinfo/"
...
TEST_XML(xpath_xalan_position_5,
...
TEST_XML(xpath_xalan_expression_1,
...
TEST_XML(xpath_xalan_predicate_2,
  ...
  CHECK_XPATH_NODESET(c, STR("bar[(@a='1' and @b='1') or (@c='1' and @d='1')]")) % 21 % 45 % 69 % 75 % 81 % 87 % 93;
  CHECK_XPATH_NODESET(c, STR("bar[@a='1' or (@b='1' and @c='1') or @d='1']")) % 9 % 21 % 33 % 39 % 45 % 51 % 57 % 63 %
      69 % 75 % 81 % 87 % 93;
  CHECK_XPATH_NODESET(c, STR("bar[(@a='1' or @b='1') and (@c='1' or @d='1')]")) % 33 % 39 % 45 % 57 % 63 % 69 % 81 %
      87 % 93;
  CHECK_XPATH_NODESET(c, STR("bar[@a='1' or @b='1' and @c='1' or @d='1']")) % 9 % 21 % 33 % 39 % 45 % 51 % 57 % 63 %
      69 % 75 % 81 % 87 % 93;
  CHECK_XPATH_NODESET(c, STR("bar[@a='1' or @b='1' or @c='1']")) % 15 % 21 % 27 % 33 % 39 % 45 % 51 % 57 % 63 % 69 %
      75 % 81 % 87 % 93;
}
...
TEST_XML(xpath_xalan_predicate_4,
...
TEST_XML(xpath_xalan_predicate_5,
  ...
  CHECK_XPATH_STRING(
      doc, STR("doc/element1[(((((2*10)-4)+9) div 5) mod floor(3))]"), STR("Test executed successfully"));
...
TEST_XML(xpath_xalan_predicate_8,
...
TEST_XML(xpath_xalan_predicate_10,
  ...
  CHECK_XPATH_STRING(
      c, STR("//child2[ancestor::element2]"), STR("Text from child2 of second element (correct execution)"));
  CHECK_XPATH_STRING(
      c, STR("//child2[ancestor-or-self::element2]"), STR("Text from child2 of second element (correct execution)"));
  CHECK_XPATH_STRING(
      c, STR("//child2[attribute::attr1]"), STR("Text from child2 of second element (correct execution)"));
}
