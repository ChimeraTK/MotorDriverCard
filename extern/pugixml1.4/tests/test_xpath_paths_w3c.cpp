...
TEST_XML(xpath_paths_w3c_8, "<node><div><font><div><div/></div></font></div></node>") {
  ...
  CHECK_XPATH_NODESET(
      n.child(STR("div")).child(STR("font")).child(STR("div")).child(STR("div")), STR("ancestor::div")) %
      5 % 3;
}
...
TEST_XML(xpath_paths_w3c_9, "<node><div><font><div><div/></div></font></div></node>") {
  ...
  CHECK_XPATH_NODESET(
      n.child(STR("div")).child(STR("font")).child(STR("div")).child(STR("div")), STR("ancestor-or-self::div")) %
      6 % 5 % 3;
}
...
TEST_XML(xpath_paths_w3c_12,
    "<chapter><para><para/><para/><foo><para/></foo></"
    "para><foo/><para/></chapter>") {
  xml_node c;
...
TEST_XML(xpath_paths_w3c_23,
    "<node><figure><figure/><figure/><foo><figure/></"
    "foo></figure><foo/><figure/></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
...
TEST_XML(xpath_paths_w3c_31b,
    "<node><abstract/><chapter/><chapter/"
    "><references/><appendix/><chapter/></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
