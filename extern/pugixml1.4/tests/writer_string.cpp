...
static bool test_narrow(const std::string &result, const char *expected,
                        size_t length) {
  // check result
...
std::string xml_writer_string::as_narrow() const { return contents; }
...
bool test_save_narrow(const pugi::xml_document &doc, unsigned int flags,
                      pugi::xml_encoding encoding, const char *expected,
                      size_t length) {
...
bool test_write_narrow(pugi::xml_node node, unsigned int flags,
                       pugi::xml_encoding encoding, const char *expected,
                       size_t length) {
  return test_narrow(write_narrow(node, flags, encoding), expected, length);
}

std::basic_string<wchar_t> write_wide(pugi::xml_node node, unsigned int flags,
                                      pugi::xml_encoding encoding) {
  xml_writer_string writer;
