...
TEST_XML(xpath_paths_axes_descendant,
  ...
  CHECK_XPATH_NODESET(doc, STR("descendant:: node()")) % 2 % 4 % 6 % 7 % 8 % 9; // node, child, subchild, another,
                                                                                // subchild, last
...
TEST_XML(xpath_paths_axes_following_sibling,
  ...
  CHECK_XPATH_NODESET(n.child(STR("child")),
      STR("following-sibling:: node()")) % 8 % 10; // another, last
  CHECK_XPATH_NODESET(n.child(STR("last")), STR("following-sibling:: node()"));

  CHECK_XPATH_NODESET(n,
...
TEST_XML(xpath_paths_axes_following,
  ...
  CHECK_XPATH_NODESET(n.child(STR("child")), STR("following:: node()")) % 8 % 9 % 10 % 11; // another, subchild, almost,
                                                                                           // last
  ...
  CHECK_XPATH_NODESET(n, STR("@attr1/following::node()")) % 5 % 7 % 8 % 9 % 10 % 11; // child, subchild, another,
                                                                                     // subchild, almost, last - because
                                                                                     // @/following
  CHECK_XPATH_NODESET(n, STR("child/@attr/following::node()")) % 7 % 8 % 9 % 10 % 11; // subchild, another, subchild,
                                                                                      // almost, last
  CHECK_XPATH_NODESET(na, STR("following::node()")) % 5 % 7 % 8 % 9 % 10 % 11; // child, subchild, another, subchild,
                                                                               // almost, last - because
                                                                               // @/following
}
...
TEST_XML(xpath_paths_axes_preceding,
  ...
  CHECK_XPATH_NODESET(n.child(STR("last")), STR("preceding:: node()")) % 11 % 9 % 8 % 7 % 5; // almost, subchild,
                                                                                             // another, subchild, child
...
TEST_XML(xpath_paths_axes_attribute,
  ...
  CHECK_XPATH_NODESET(doc,
      STR("descendant-or-self:: node()/attribute:: node()")) % 3 % 4 % 6; // all attributes
  CHECK_XPATH_NODESET(n.child(STR("another")),
...
TEST_XML(xpath_paths_axes_descendant_or_self,
  ...
  CHECK_XPATH_NODESET(n, STR("descendant-or-self:: node()")) % 2 % 4 % 6 % 7 % 8 % 9; // node, child, subchild, another,
                                                                                      // subchild, last
  CHECK_XPATH_NODESET(doc, STR("descendant-or-self:: node()")) % 1 % 2 % 4 % 6 % 7 % 8 % 9; // root, node, child,
                                                                                            // subchild, another,
                                                                                            // subchild, last
...
TEST_XML(xpath_paths_axes_ancestor_or_self,
  ...
  CHECK_XPATH_NODESET(n, STR("child/subchild/ancestor-or-self:: node()")) % 6 % 4 % 2 % 1;  // subchild, child, node,
                                                                                            // root
...
TEST_XML_FLAGS(xpath_paths_nodetest_principal,
    "<node attr='value'>pcdata<child/><?pi1 value?><?pi2 "
  ...
  CHECK_XPATH_NODESET(doc, STR("node/attribute::attr/self::attr")); // attribute is not of
                                                                    // element type
  ...
  CHECK_XPATH_NODESET(doc,
      STR("node/attribute::attr/descendant-or-self::attr")); // attribute is not
                                                             // of element type
  ...
  CHECK_XPATH_NODESET(doc, STR("node/attribute::*/descendant-or-self::*")); // attribute is not
                                                                            // of element type
  ...
  CHECK_XPATH_NODESET(doc, STR("child::abra:*/attribute::abra:*/ancestor-or-self::abra:*")) % 10; // attribute is not of
                                                                                                  // element type
  CHECK_XPATH_NODESET(doc, STR("child::abra:*/descendant-or-self::abra:*")) % 10;
  CHECK_XPATH_NODESET(doc,
      STR("child::abra:*/attribute::abra:*/"
          "descendant-or-self::abra:*")); // attribute is not of
                                          // element type
}
