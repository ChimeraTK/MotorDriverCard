 ...
 */
template <typename T> class UnitsConverter {
public:
 ...
 * @tparam T Type of the user-unit
 */
template <typename T> class UnitsConverterTrivia : public UnitsConverter<T> {
public:
 ...
 */
template <typename T> class ScalingUnitsConverter : public UnitsConverter<T> {
