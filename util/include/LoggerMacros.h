...
#define STD_LOGGER_FL(MESSAGE_LEVEL)                                                                                   \
  mtca4u::_logstdout__(MESSAGE_LEVEL) << __FILE__ << " - Line: " << __LINE__ << " -> ";                                \
  mtca4u::_logstdout__(MESSAGE_LEVEL)

#define ERR_LOGGER_FL(MESSAGE_LEVEL)                                                                                   \
  mtca4u::_logstderr__(MESSAGE_LEVEL) << __FILE__ << " - Line: " << __LINE__ << " -> ";                                \
  mtca4u::_logstderr__(MESSAGE_LEVEL)

#define STD_LOGGER_FLD(MESSAGE_LEVEL)                                                                                  \
  mtca4u::_logstdout__(MESSAGE_LEVEL) << __FILE__ << " - Line: " << __LINE__ << " Date: " << __DATE__ << " "           \
                                      << __TIME__ << " -> ";                                                           \
  mtca4u::_logstdout__(MESSAGE_LEVEL)

#define ERR_LOGGER_FLD(MESSAGE_LEVEL)                                                                                  \
  mtca4u::_logstderr__(MESSAGE_LEVEL) << __FILE__ << " - Line: " << __LINE__ << " Date: " << __DATE__ << " "           \
                                      << __TIME__ << " -> ";                                                           \
  mtca4u::_logstderr__(MESSAGE_LEVEL)

#define STD_LOGGER_D(MESSAGE_LEVEL)                                                                                    \
  mtca4u::_logstdout__(MESSAGE_LEVEL) << " Date: " << __DATE__ << " " << __TIME__ << " -> ";                           \
  mtca4u::_logstdout__(MESSAGE_LEVEL)

#define ERR_LOGGER_D(MESSAGE_LEVEL)                                                                                    \
  mtca4u::_logstderr__(MESSAGE_LEVEL) << " Date: " << __DATE__ << " " << __TIME__ << " -> ";                           \
  mtca4u::_logstderr__(MESSAGE_LEVEL)
