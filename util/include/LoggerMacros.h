...
#define STD_LOGGER_SET_LOG_LEVEL(LOG_LEVEL)                                    \
  mtca4u::_logstdout__.setLogLevel(LOG_LEVEL);
#define ERR_LOGGER_SET_LOG_LEVEL(LOG_LEVEL)                                    \
  mtca4u::_logstderr__.setLogLevel(LOG_LEVEL);
...
#define STD_LOGGER_FLD(MESSAGE_LEVEL)                                          \
  mtca4u::_logstdout__(MESSAGE_LEVEL)                                          \
      << __FILE__ << " - Line: " << __LINE__ << " Date: " << __DATE__ << " "   \
      << __TIME__ << " -> ";                                                   \
  mtca4u::_logstdout__(MESSAGE_LEVEL)
