...
#pragma GCC diagnostic pop
  ...
  ParametersCalculator::PhysicalParameters maxPulseDivParameters(
      32, // max system clock
      1,  // min microsteps
      200,
      4,   // very low maxRPM
  ...
  ParametersCalculator::PhysicalParameters largePulseDivParameters =
      vt21Parameters;
  ...
  ParametersCalculator::PhysicalParameters minPulseDivParameters(
      2, // low system clock
      16, 200,
      2000, // high maxRPM
      0.5, 0.24);
  ...
  ParametersCalculator::PhysicalParameters smallPulseDivParameters(
      16, 16, 800, 2000, 0.5, 0.24);
  ...
  BOOST_CHECK_THROW(
      ParametersCalculator::calculateParameters(tooSlowParameters),
      std::out_of_range);
}
...
#pragma GCC diagnostic pop
  ...
  ParametersCalculator::PhysicalParameters maxRampDivParameters =
      vt21Parameters;
  ...
  ParametersCalculator::PhysicalParameters largeRampDivParameters =
      vt21Parameters;
  ...
  // 'static_cast<int>(pulseDiv) = 0 and pulseDiv is in a bad range
  // so v_max is out of range' is covered
  ParametersCalculator::PhysicalParameters minRampDivParameters(
      8, 8, 200, 5000,
  ...
  ParametersCalculator::PhysicalParameters smallRampDivParameters(
      8, 16, 200, 2000,
