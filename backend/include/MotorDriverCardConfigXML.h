...
public:
  ...
  static void writeSparse(std::string fileName,
                          MotorDriverCardConfig const &motorDriverCardConfig);
...
private:
  ...
  static MotorControlerConfig
  parseControlerConfig(pugi::xml_node const &controlerConfigXML);
   ...
   */
  static void
  checkForOldInvalidTagName(std::string const &parameterName,
                            pugi::xml_node const &parentNode,
                            std::string const &tagName = "Register");
