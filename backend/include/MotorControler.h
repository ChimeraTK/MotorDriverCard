...
namespace mtca4u {
  ...
  class MotorControler {
   public:
    ...
    virtual unsigned int getActualAcceleration() = 0; ///< Get the actual acceleration in steps per
                                                      ///< square FIXME
    virtual unsigned int getMicroStepCount() = 0;     ///< Get the micro step value (which units? what does
                                                      ///< it mean?)
    ...
    virtual MotorReferenceSwitchData getReferenceSwitchData() = 0; ///< Get information about both reference
    ...
    MC_DECLARE_SET_GET_VALUE(MaximumAcceleration,
