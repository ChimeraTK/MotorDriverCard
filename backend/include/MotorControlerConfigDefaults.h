...
unsigned int const STALL_GUARD_CONTROL_DEFAULT =
    0x10000; ///< stall guard with current scale 1/32 of the max possible
             ///< current
unsigned int const COOL_STEP_CONTROL_DEFAULT = 0x0; ///< cool step off
unsigned int const DRIVER_CONFIG_DEFAULT =
    0x00040; ///< full-scale sense register voltage is 165 mV. Do not modify for
             ///< MD22
...
unsigned int const MINIMUM_VELOCITY_DEFAULT =
    0x1; ///< Should be 1 according to data sheet
