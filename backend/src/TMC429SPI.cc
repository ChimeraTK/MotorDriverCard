...
TMC429SPI::TMC429SPI(boost::shared_ptr<ChimeraTK::Device> const &device,
    ...
    : _spiViaPCIe(device, moduleName, writeRegisterName, syncRegisterName,
                  readbackRegisterName, spiWaitingTime) {}
...
void TMC429SPI::write(unsigned int smda, unsigned int idx_jdx,
                      unsigned int data) {
