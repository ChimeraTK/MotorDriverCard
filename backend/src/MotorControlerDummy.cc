...
MotorControlerDummy::MotorControlerDummy(unsigned int id)
    : _motorControllerDummyMutex(), _absolutePosition(0), _targetPosition(0),
      _currentPosition(0), _calibrationTime(0), _positiveEndSwitchEnabled(true),
      _negativeEndSwitchEnabled(true), _motorCurrentEnabled(false),
      _endSwitchPowerEnabled(false), _positiveEndSwitchPosition(10000),
      _negativeEndSwitchPosition(-10000),
      _userSpeedLimit(100000), /* some arbitatry high value */
      _id(id), _blockMotor(false), _bothEndSwitchesAlwaysOn(false),
      _userMicroStepSize(4), _isFullStepping(false) {
...
void MotorControlerDummy::setActualVelocity(int /*stepsPerFIXME*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setActualVelocity() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

void MotorControlerDummy::setActualAcceleration(
    unsigned int /*stepsPerSquareFIXME*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setActualAcceleration() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

void MotorControlerDummy::setMicroStepCount(unsigned int /*microStepCount*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setMicroStepCount() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}
...
void MotorControlerDummy::setDecoderReadoutMode(
    unsigned int /*decoderReadoutMode*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setDecoderReadoutMode(): The Decoder readout mode "
...
void MotorControlerDummy::setPositiveReferenceSwitchCalibration(
...
void MotorControlerDummy::setNegativeReferenceSwitchCalibration(
    int calibratedPosition) {
  // TODO
  (void)calibratedPosition;
}
...
void MotorControlerDummy::roundToNextFullStep(int &targetPosition) {
  ...
  unsigned int actualMicroStepCount =
      ((_currentPosition * _userMicroStepSize) - 1) & 0x3FF;
...
void MotorControlerDummy::setMinimumVelocity(unsigned int /*stepsPerFIXME*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setMinimumVelocity() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

unsigned int MotorControlerDummy::getMinimumVelocity() {
  throw MotorDriverException(
      "MotorControlerDummy::getMinimumVelocity() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

void MotorControlerDummy::setMaximumVelocity(unsigned int /*stepsPerFIXME*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setMaximumVelocity() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

unsigned int MotorControlerDummy::getMaximumVelocity() {
  throw MotorDriverException(
      "MotorControlerDummy::getMaximumVelocity() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

void MotorControlerDummy::setTargetVelocity(int /*stepsPerFIXME*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setTargetVelocity() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

int MotorControlerDummy::getTargetVelocity() {
  throw MotorDriverException(
      "MotorControlerDummy::getTargetVelocity() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

void MotorControlerDummy::setMaximumAcceleration(
    unsigned int /*stepsPerSquareFIXME*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setMaximumAcceleration() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

unsigned int MotorControlerDummy::getMaximumAcceleration() {
  throw MotorDriverException(
      "MotorControlerDummy::getMaximumAcceleration() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

void MotorControlerDummy::setPositionTolerance(unsigned int /*steps*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setPositionTolerance() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

unsigned int MotorControlerDummy::getPositionTolerance() {
  throw MotorDriverException(
      "MotorControlerDummy::getPositionTolerance() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}

void MotorControlerDummy::setPositionLatched(unsigned int /*steps*/) {
  throw MotorDriverException(
      "MotorControlerDummy::setPositionLatched() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}
...
bool MotorControlerDummy::isPositiveEndSwitchActive() {
  ...
  return _positiveEndSwitchEnabled &&
         (_absolutePosition >= _positiveEndSwitchPosition);
}
...
double MotorControlerDummy::setUserCurrentLimit(double currentLimit) {
  ...
  throw MotorDriverException(
      "MotorControlerDummy::setUserCurrentLimit() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}
double MotorControlerDummy::getUserCurrentLimit() {
  throw MotorDriverException(
      "MotorControlerDummy::getUserCurrentLimit() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}
double MotorControlerDummy::getMaxCurrentLimit() {
  throw MotorDriverException(
      "MotorControlerDummy::getMaxCurrentLimit() is not implemented yet!",
      MotorDriverException::NOT_IMPLEMENTED);
}
...
bool MotorControlerDummy::isNegativeEndSwitchActive() {
  ...
  return _negativeEndSwitchEnabled &&
         (_absolutePosition <= _negativeEndSwitchPosition);
}

void MotorControlerDummy::moveTowardsTarget(float fraction, bool block,
                                            bool bothEndSwitchesAlwaysOn,
                                            bool zeroPositions) {
  lock_guard guard(_motorControllerDummyMutex);
  if (zeroPositions) {
    _absolutePosition = 0;
