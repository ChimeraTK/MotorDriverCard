...
namespace mtca4u
{
  ...
  public:
    ...
    virtual unsigned int getStallGuardValue()=0; ///< Get the stall guard value  (which units? what does it mean? Expert?)
    virtual unsigned int getCoolStepValue()=0; ///< Get the CoolStepValue (in units?, what does it mean? Expert?)
