...
namespace mtca4u{
  ...
  public:
    DriverControlData(unsigned int dataWord = 0): MultiVariableWord(dataWord){
  ...
  public:
    ChopperControlData(unsigned int dataWord = 0): MultiVariableWord(dataWord){
  ...
  public:
    CoolStepControlData(unsigned int dataWord = 0): MultiVariableWord(dataWord){
  ...
  public:
    StallGuardControlData(unsigned int dataWord = 0): MultiVariableWord(dataWord){
  ...
  public:
    DriverConfigData(unsigned int dataWord = 0): MultiVariableWord(dataWord){
